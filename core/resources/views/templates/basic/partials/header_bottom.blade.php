        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav nav-menu ms-auto align-items-lg-center">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="http://oprimeaccs.com">@lang('Home')</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('products') }}">@lang('Buy Logs')</a>
                    </li>
                                        <li class="nav-item">
                    ...
                    <!--</li>-->
                                         <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="https://oprimeaccs.com/account/user/deposit/new">@lang('Deposit')</a>
                    </li>
                                        <li class="nav-item">
                        <a class="nav-link" href="https://youtu.be/X1uQPp7JZik?si=3IhZv82B5m6mxhDa">@lang('How to buy Logs')</a>
                    </li>

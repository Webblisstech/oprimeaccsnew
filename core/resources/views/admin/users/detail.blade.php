...
@section('panel')
    ...
    <div class="card mt-30">
                <div class="card-header">
                    <h5 class="card-title mb-0">@lang('Fund') {{$user->fullname}} account </h5>
                    <h6>@lang('Current user balance:') {{$user->balance}} </h6>
                </div>
                <div class="card-body">
                    <form action="{{route('admin.users.funduser',[$user->id])}}" method="POST"
                          enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="">
                            <div class="">
                                <div class="form-group ">
                                    ...
                                    <input class="form-control" type="number" name="balance" required placeholder="0.0">
                                </div>
                            </div>
                        </div>
